          ...
          <Row className="row-grid justify-content-between align-items-center">
            <Col lg="6">
              ...
              <div className="btn-wrapper">
                <Button color="success" tag={Link} to="/login-page">
                  Login Page
                </Button>
                <Button className="btn-white" color="default" tag={Link} to="/register-page">
                  Register Page
                </Button>
              </div>
            </Col>
              ...
              <div className="transform-perspective-right">
                <Card className="bg-secondary shadow border-0">
                  ...
                  <CardBody className="px-lg-5 py-lg-5">
                    ...
                    <Form role="form">
                      <FormGroup className={classnames("mb-3", { focused: emailFocused })}>
                        <InputGroup className="input-group-alternative">
                          ...
                          <Input placeholder="Email" type="email" onFocus={() => setEmailFocused(true)} onBlur={() => setEmailFocused(false)} />
                        </InputGroup>
                      </FormGroup>
                      <FormGroup className={classnames({ focused: passwordFocused })}>
                        <InputGroup className="input-group-alternative">
                          <InputGroupAddon addonType="prepend">
                            <InputGroupText>
                          ...
                          <Input placeholder="Password" type="password" autoComplete="off" onFocus={() => setPasswordFocused(true)} onBlur={() => setPasswordFocused(false)} />
                        </InputGroup>
                      </FormGroup>
